...
void main() {
  group('JWT System Simple Tests', () {
    ...
    test('JWTValidatorBase should be const constructible', () {
      ...
      expect(validator.defaultErrorMessage, equals('Administrator access required'));
    });
    ...
    test('JWT validation should work with mock payload', () {
      ...
      expect(invalidResult.errorMessage, equals('User must be an administrator'));
    });
    ...
    test('Department validator should work correctly', () {
      ...
      final invalidDeptResult = validator.validate(mockRequest, invalidDeptPayload);
      ...
      final invalidLevelResult = validator.validate(mockRequest, invalidLevelPayload);
      expect(invalidLevelResult.isValid, equals(false));
      expect(invalidLevelResult.errorMessage, contains('Management level access required'));
    });
    ...
    test('Financial validator should validate correctly', () {
      ...
      final invalidClearanceResult = validator.validate(mockRequest, invalidClearancePayload);
      expect(invalidClearanceResult.isValid, equals(false));
      expect(invalidClearanceResult.errorMessage, contains('Insufficient clearance level'));
      ...
      final invalidCertResult = validator.validate(mockRequest, invalidCertPayload);
      expect(invalidCertResult.isValid, equals(false));
      expect(invalidCertResult.errorMessage, contains('Financial operations certification required'));
    });
    ...
    test('Business hours validator should check time restrictions', () {
      ...
      final afterHoursResult = validator.validate(mockRequest, afterHoursPayload);
      ...
      final noAfterHoursResult = validator.validate(mockRequest, noAfterHoursPayload);
